...
import linkedin.models.Education;
import linkedin.models.Experience;
...
public class LinkedMain {
    public static void main(String[] args) {
        ...
        system.rejectConnectionRequest(requestId2);
        ...
        if (bobsPost != null) {
            ...
            // Charlie joins the conversation. Bob (author) and Alice (a commenter) are both notified.
            bobsPost.addComment(charlie, "Congrats on the launch!");
        }

        // Bob sees Alice's like and both comments.
        bob.viewNotifications();
        // Alice commented earlier, so she is notified when Charlie comments too.
